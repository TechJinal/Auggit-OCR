...
model_path = r'app/runs/train/exp16/weights/best.pt'
...
async def process_yelo(file: UploadFile):
    # Dummy implementation of the Yelo processing function
